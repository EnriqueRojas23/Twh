...
namespace CargaClic.Data
{
    public class DataContext : DbContext // Usar, modificar o ampliar métodos de esta clase
    {
        ...
        public DbSet<GuiaCabecera> guiaCabeceras {get;set;}
        public DbSet<GuiaDetalle> guiaDetalle {get;set;}
        public DbSet<ErrorGuia>  errorGuias {get;set;}
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfiguration(new GuiaCabeceraConfiguration());
            builder.ApplyConfiguration(new GuiaDetalleConfiguration());
            builder.ApplyConfiguration(new ErrorGuiaConfiguration());
